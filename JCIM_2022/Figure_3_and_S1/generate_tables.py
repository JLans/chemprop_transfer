...
if __name__ == '__main__':
    target = 'log10h50(exp)'
    final_df = DataFrame(data={'epochs':[], 'val_frac':[]
    ...
    final_df.sort_values(by=['val_frac', 'epochs'], inplace=True)
    final_df.to_csv('./direct_models_b5_branched.csv', index=False)